 ...
 */
final class Version20260419175707 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE products (id INT AUTO_INCREMENT NOT NULL, ref VARCHAR(36) NOT NULL, title VARCHAR(255) DEFAULT NULL, name VARCHAR(128) NOT NULL, description LONGTEXT DEFAULT NULL, price NUMERIC(10, 2) NOT NULL, stock INT NOT NULL, category VARCHAR(100) DEFAULT NULL, image VARCHAR(500) DEFAULT NULL, rating_rate NUMERIC(3, 1) DEFAULT 0 NOT NULL, rating_count INT DEFAULT 0 NOT NULL, created_at DATETIME NOT NULL, producer_id INT NOT NULL, UNIQUE INDEX UNIQ_B3BA5A5A146F3EA3 (ref), INDEX IDX_B3BA5A5A89B658FE (producer_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
